...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f('opcoes_proxima_pergunta_id_fkey'), 'opcoes', type_='foreignkey')
    op.drop_constraint(op.f('opcoes_pergunta_id_fkey'), 'opcoes', type_='foreignkey')
    op.create_foreign_key(None, 'opcoes', 'perguntas', ['proxima_pergunta_id'], ['id'])
    op.create_foreign_key(None, 'opcoes', 'perguntas', ['pergunta_id'], ['id'])
