...
def read_coletas_monitoramento(
    *,
    ...
    coletas_query = db.query(
        ...
        models.Coleta.is_synthetic,
        models.Coleta.seed_run_id,
        models.Coleta.synthetic_source,
    ...
    for coleta in coletas_query:
        ...
        resultado.append({
            ...
            "is_synthetic": coleta.is_synthetic,
            "seed_run_id": coleta.seed_run_id,
            "synthetic_source": coleta.synthetic_source,
    ...
    *,
    ...
    for c in coletas_query:
        ...
        resultado.append({
            ...
            "seed_run_id": c.seed_run_id,
            "synthetic_source": c.synthetic_source,
            "localizacao_inicio": localizacao_inicio,
            "localizacao_fim": localizacao_fim,
